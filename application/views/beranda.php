                ...
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                <li <?php echo "active"; ?>><a href="<?= base_url() ?>">Home</a></li>
                                
                                <li <?php echo "active"; ?>><a href="<?= base_url() ?>">Kategori<span class="arrow_carrot-down"></span></a>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero__slider owl-carousel">
                <div class="hero__items set-bg" data-setbg="<?= base_url('assets/sneat/upload/caraousel/'.$aa['foto']) ?>">
                    <div class="row">
                        <div class="col-lg-6">
...
<script src="<?= base_url('assets/front/'); ?>/player.js"></script>
