...
>
  <head>
    ...
    <link rel="stylesheet" href="<?= site_url('assets/sneat') ?>/assets/vendor/libs/apex-charts/apex-charts.css" />
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= base_url(); ?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Cessa</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php if($menu=='caraousel'){ echo "active"; } ?>">
              <a href="<?= site_url('admin/caraousel') ?>" class="menu-link">
                ...
                <div data-i18n="Boxicons">Caraousel</div>
              </a>
            </li>
            ...
            <li class="menu-item <?php if($menu=='kategori'){ echo "active"; } ?>">
              <a href="<?= site_url('admin/kategori') ?>" class="menu-link">
                ...
                <div data-i18n="Tables">Kategori Konten</div>
              </a>
            </li>
            ...
            <li class="menu-item <?php if($menu=='konten'){ echo "active"; } ?>">
              <a href="<?= site_url('admin/konten') ?>" class="menu-link">
                ...
                <div data-i18n="Tables">Konten</div>
              </a>
            </li>
          </ul>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <!-- Content -->
            <div class="container-xxl flex-glow-l container-p-y">
                <?= $contents; ?>
            </div>
          </div>
            <!-- / Content -->
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Cessa</a>
                </div>
            </div>
              </div>
            </footer>
